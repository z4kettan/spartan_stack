    ...
    @if (collapsible() === 'none') {
      ...
      >
        <div
          ...
          class="bg-sidebar backdrop-blur-xl border-r border-white/10 group-data-[variant=floating]:ring-sidebar-border group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:shadow-sm
